...
use \Exception;
use \PDO;
use Demo\Author as ChildAuthor;
use Demo\AuthorQuery as ChildAuthorQuery;
use Demo\Map\AuthorTableMap;
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Demo\Base\AuthorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Demo\\Author', $modelAlias = null)
    {
