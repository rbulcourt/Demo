...
use \Exception;
use \PDO;
use Demo\Publisher as ChildPublisher;
use Demo\PublisherQuery as ChildPublisherQuery;
use Demo\Map\PublisherTableMap;
 ...
 *
 * @method     \Demo\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Demo\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Demo\\Publisher', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Demo\Book object
     *
     * @param \Demo\Book|ObjectCollection $book the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByBook($book, $comparison = null)
    {
        if ($book instanceof \Demo\Book) {
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \Demo\Book or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Demo\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Demo\BookQuery');
    }
