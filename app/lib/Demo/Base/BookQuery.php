...
use \Exception;
use \PDO;
use Demo\Book as ChildBook;
use Demo\BookQuery as ChildBookQuery;
use Demo\Map\BookTableMap;
 ...
 *
 * @method     \Demo\PublisherQuery|\Demo\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Demo\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Demo\\Book', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Demo\Publisher object
     *
     * @param \Demo\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($publisher instanceof \Demo\Publisher) {
            return $this
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \Demo\Publisher or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Demo\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\Demo\PublisherQuery');
    }

    /**
     * Filter the query by a related \Demo\Author object
     *
     * @param \Demo\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($author instanceof \Demo\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \Demo\Author or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Demo\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\Demo\AuthorQuery');
    }
