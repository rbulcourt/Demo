...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Demo.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\Demo\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Demo.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Demo\\Book');
        $this->setPackage('Demo');
    ...
    {
        $this->addRelation('Publisher', '\\Demo\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\Demo\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Demo\Book) { // it's a model object
