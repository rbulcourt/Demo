...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Demo.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\Demo\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Demo.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Demo\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\Demo\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Demo\Publisher) { // it's a model object
