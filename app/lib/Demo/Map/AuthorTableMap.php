...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Demo.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\Demo\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Demo.Author';
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Demo\Author) { // it's a model object
